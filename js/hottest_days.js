function filterHot(category){
  ...
  var bar_chart = d3.select("#hottest_days").append("svg")
      .attr("width", width + left_margin);

  d3.csv("csv/hottest_days.csv", function(error, data) {
    ...
    bar_chart.append("text")
        ...
        .text("Rides on 2014's 30 Hottest Days")
